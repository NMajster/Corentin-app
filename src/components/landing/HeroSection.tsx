      ...
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-32">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-center lg:text-left">
            ...
            {/* Titre principal */}
            <h1 className="animate-fade-in-up animation-delay-100 text-4xl sm:text-5xl lg:text-6xl font-serif font-bold text-white leading-tight mb-6">
              Victime de fraude bancaire ?{" "}
              <span className="text-accent">Votre banque refuse de rembourser ?</span>
            </h1>

            {/* Sous-titre */}
            <p className="animate-fade-in-up animation-delay-200 text-xl text-white/80 mb-4 max-w-xl mx-auto lg:mx-0">
              <strong className="text-white">Nous les assignons.</strong>
            </p>
            
            <p className="animate-fade-in-up animation-delay-300 text-lg text-white/70 mb-8 max-w-xl mx-auto lg:mx-0">
            ...
            {/* CTA Buttons */}
            <div className="animate-fade-in-up animation-delay-400 flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
              <Button
                asChild
                size="lg"
                className="bg-accent hover:bg-accent/90 text-accent-foreground font-bold text-lg px-8 py-6 animate-pulse-accent"
              >
                <a href="#contact">
                  Prendre RDV (90€)
            ...
            {/* Stats rapides */}
            <div className="animate-fade-in-up animation-delay-500 mt-12 grid grid-cols-3 gap-6 max-w-lg mx-auto lg:mx-0">
              <div className="text-center lg:text-left">
